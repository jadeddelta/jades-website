...
export const TimelineList: TimelineEntry[] = [
{
    ...
    endDate: "Present",
    description: `
        Immediately after graduation, I began working full-time underneath the same POSE grant as
        a full-time Research Software Engineer, greatly expanding my responsibilities and scope of work.
        In this role, I..
    `,
    points: [
        `continue my work as a core maintainer of <b>jsPsych</b>, particularly in a managerial role,
        as I oversee the work of 4 other part-time students working on the library, but also expanding my 
        own contributions to the codebase and code review processes with our backlog.`,
        `expand the jsPsych "timelines" functionality, a new paradigm that allows for parameterizable, 
        resuable experiment structures, through extensive review of the student team's work, along with
        my own contributions.`,
        `engage in a grant offered by the <b>Center for Open Science</b> to improve interconnectivity between itself
        and DataPipe, a lightweight service for providing born-open data to <b>Open Science Foundation</b> repositories.`,
        `architect an <b>OAuth</b> solution to allow for OSF users to log into DataPipe with their existing credentials,
        supported through the existing <b>Firebase</b> backend, all written in <b>TypeScript</b>. work on this was conducted 
        in lieu with the COS team themselves, allowing me to gain experience on working with their Python backend "GravyValet".`,
        `present posters at various conferences such as <b>Society for Computation in Psychology (SCiP)</b> and
        <b>US Research Software Engineer Association (US-RSE)</b>, detailing the work done on jsPsych timelines and our
        findings for open source and open science community building.`
    ]
},
{
    ...
    description: `
        ...
        (Pathways to Enable Open-Source Ecosystems) grant, where I focused my efforts primarily on 
        jsPsych. In this role, I...
    `,
    points: [
        `maintained and developed <b>jsPsych</b> as the most recently promoted core maintainer, 
        engaging in <b>code review</b>, merging pull requests, and spearheading the work on
        new features.`,
        `implemented said features into new plugins and core functionality of the library, such as
        developing a plugin to determine if a user is wearing headphones or not for an experiment.`,
        `collaborated with the jsPsych community, expanding community outreach and engagement 
...
},
{
    ...
    points: [
        ...
        `spearheaded a modernization of Vassar College's turing machine simulator, updating a 7-year-old
